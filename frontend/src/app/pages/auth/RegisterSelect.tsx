...
const registerOptions = [
  {
    title: "Buyer Account",
    description:
      "Create a buyer account to purchase steel products. You will choose the buyer type in the next step.",
    icon: ShoppingCart,
    path: "/register/buyer",
  },
  {
    ...
    description:
      "Join as a supplier to list products, receive orders, and connect with buyers across Saudi Arabia.",
    icon: Factory,
      ...
      <div className="mx-auto w-full max-w-5xl">
        ...
        <div className="mb-10 text-center">
          ...
          <p className="mt-3 text-base text-[#6B7280]">
            Select the account type you want to create on Steel Platform.
          </p>
        </div>
